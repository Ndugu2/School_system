...
function DashboardContent({ onSwitchToAdminPortal }) {
  ...
  if (!canAccessTab(user.role, currentTab)) {
    return (
      <Layout currentTab={currentTab} setCurrentTab={setCurrentTab}>
        <div style={styles.denied}>You do not have permission to access this area.</div>
      </Layout>
    );
  }
  ...
  return (
    <div>
      <div style={styles.banner}>
        <span>Legacy Prototype Backup Mode</span>
        {onSwitchToAdminPortal && (
          <button style={styles.bannerBtn} onClick={onSwitchToAdminPortal}>
            Switch to New Dynamic Admin Portal &rarr;
          </button>
        )}
      </div>
      <Layout currentTab={currentTab} setCurrentTab={setCurrentTab}>
...
export default function LegacyApp({ onSwitchToAdminPortal }) {
  return (
    <DashboardContent onSwitchToAdminPortal={onSwitchToAdminPortal} />
  );
}
