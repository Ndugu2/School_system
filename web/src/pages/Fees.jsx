...
export default function Fees() {
  const { user } = useAuth();
  const canConfigureFees = ['admin', 'super-admin'].includes(user?.role);
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.topGrid}>
        {/* Fee structures are controlled by school administrators. */}
        {canConfigureFees && <div style={styles.panel}>
