...
export default function Layout({ children, currentTab, setCurrentTab }) {
  ...
  return (
    <div className="app-shell" style={styles.appContainer}>
      {/* Sidebar */}
      <aside className="app-sidebar" style={{ ...styles.sidebar, left: sidebarOpen ? 0 : '-280px' }}>
        <div className="app-sidebar-header" style={styles.sidebarHeader}>
        ...
        <nav className="app-navigation" style={styles.navigation}>
        ...
        <div className="app-sidebar-footer" style={styles.sidebarFooter}>
          <button className="app-logout" onClick={logout} style={styles.logoutBtn}>
            <LogOut size={20} />
            <span>Sign Out</span>
          </button>
        </div>
      ...
      {/* Main Content Area */}
      <div className="app-main" style={{ ...styles.mainArea, marginLeft: sidebarOpen ? 'var(--sidebar-width)' : 0 }}>
        {/* Topbar */}
        <header className="app-header" style={styles.header}>
          ...
          <div className="app-header-actions" style={styles.headerRight}>
            {/* Theme Toggle */}
            <button className="app-icon-button" onClick={toggleTheme} style={styles.iconBtn} aria-label="Change colour theme">
              {theme === 'light' ? <Moon size={20} /> : <Sun size={20} />}
            </button>

            {/* Notification Badge */}
            <button className="app-icon-button" style={styles.iconBtn} aria-label="View notifications">
              <Bell size={20} />
            </button>

            {/* Profile Summary */}
            <div className="app-profile" style={styles.profileBadge}>
        ...
        <main className="app-content" style={styles.contentBody}>
